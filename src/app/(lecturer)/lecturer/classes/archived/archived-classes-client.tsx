...
export function ArchivedClassesClient({ classes }: { classes: ArchivedClassCard[] }) {
  ...
  return (
    <div className="space-y-8">
      {/* ── Hero band ── */}
      <section className="relative overflow-hidden rounded-[28px] border-[3px] border-border bg-gradient-to-br from-orange-100 via-orange-50 to-blue-50 p-6 shadow-[var(--shadow-clay)] md:p-8">
